    ...
    <div>
        ...
        <form method="POST">
            ...
            <div class="mailbomb_users_list_delete_btn">
                <div class="mailbomb_user_list_delete_js"></div>
                <div id="_users_list_selected_delete" class="mailbomb-btn mailbomb-btn-grey">Supprimer</div>
                <input disabled="disabled" class="mailbomb-btn mailbomb-btn-red" id="users_list_selected_delete" name="users_list_selected_delete" type="submit" value="Supprimer">
            </div>

            <div class="mailbomb_user_list_table_container">
                ...
                <table class="mailbomb_users_table">
                    <thead>
                        ...
                        <th class="mailbomb_users_th">Dernière newsletter reçue</th>
                    ...
                    <tbody>
                        ...
                        <?php if( $userLists ): foreach( $userLists as $userList ): ?>
                            ...
                            <tr class="mailbomb_users_tr">
                                ...
                                <td class="mailbomb_users_td"><div><?php echo $userList->last_newsletter_sending; ?></div></td>
                ...
                <div class="mailbomb_user_list_loader"><div class="mailbomb_text_loader">Envoi des emails de désinscription...</div></div>
